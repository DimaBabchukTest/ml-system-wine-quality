...
- A complete end-to-end data science workflow (see 'jupyter_notebook/Wine_Rate.ipynb' [a link](jupyter_notebook/Wine_Rate.ipynb))

---

## 1. Dataset Description

This project uses the **Wine Quality Dataset** from the  **UCI Machine Learning Repository** [a link](https://archive.ics.uci.edu/dataset/186/wine+quality)
